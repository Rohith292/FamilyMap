...
function FamilyTreeContent({ shareId, isAuthenticated, ownerId, groupId }) {
    ...
    return (
        <div className="p-8 text-base-content flex-1 flex flex-col">
            {groupId && (
                // FIX: Replaced hardcoded button colors with theme-aware classes
                <button
                    onClick={handleBackClick}
                    className="btn btn-ghost text-success hover:text-success-content hover:bg-success flex items-center gap-2 mb-4"
                >
