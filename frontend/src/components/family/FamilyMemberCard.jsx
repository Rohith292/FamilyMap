    ...
    <div className="bg-base-200 p-6 rounded-lg shadow-lg text-base-content">
      ...
      <div className="flex justify-center mb-4">
        <img
          ...
          className="w-24 h-24 rounded-full object-cover border-2 border-base-300 shadow-md"
      ...
      <div className="space-y-3 text-lg">
        ...
        <p className="text-sm text-base-content/60 mt-4">ID: {member._id}</p>

        {/* FIX: Replaced 'text-gray-500' and 'text-white' */}
        <p className="text-sm text-base-content/60 mt-2">DEBUG: canEdit prop received: <span className="font-bold text-base-content">{String(canEdit)}</span></p>
        {/* FIX: Replaced 'text-gray-500' and 'text-white' */}
        <p className="text-sm text-base-content/60 mt-2">DEBUG: isOwner prop received: <span className="font-bold text-base-content">{String(isOwner)}</span></p>
      </div>
    </div>
  );
}
